                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                            <li><a  href="AjouterEvenement.php" > New </a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                            <li><a  href="AjouterSponsor.php" > New </a></li>
...
include '../view/afficherSponsor.php';
...
?>     
            ...
            <footer class="footer">
                © 2023 - 2024  Green House <span class="d-none d-sm-inline-block"> - Crafted with <i class="mdi mdi-heart text-danger"></i> by houssem</span>.
            </footer>
    ...
    <script src="assetss/js/waves.min.js"></script>

    <!--Morris Chart-->
    <script src="../plugins/morris/morris.min.js"></script>
    <script src="../plugins/raphael/raphael.min.js"></script>

    <script src="assetss/pages/dashboard.init.js"></script>
